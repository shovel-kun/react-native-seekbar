...
namespace margelo::nitro::seekbar {
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/seekbar/Func_void_double;";
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/seekbar/Func_void_double_cxx;";
