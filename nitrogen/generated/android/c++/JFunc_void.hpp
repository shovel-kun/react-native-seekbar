...
namespace margelo::nitro::seekbar {
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/seekbar/Func_void;";
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/seekbar/Func_void_cxx;";
